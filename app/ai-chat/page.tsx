...
export default function ChatInterface() {
  ...
  return (
    <main
      className="relative min-h-[70vh] overflow-hidden rounded-none px-4 py-10 sm:px-8"
      style={{
        background:
          'radial-gradient(1200px 500px at 12% -10%, #c5ddd1 0%, transparent 55%), radial-gradient(900px 420px at 90% 0%, #c9d8e8 0%, transparent 50%), linear-gradient(165deg, #eef3f0 0%, #e4ebe7 45%, #dce6e1 100%)',
      }}
    >
      {/* ambient grid */}
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(18,32,24,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(18,32,24,0.06) 1px, transparent 1px)',
